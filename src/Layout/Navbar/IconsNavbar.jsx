...
import UserOpenMenuIcon from "../../components/Shared/ProfileAssets/UserOpenMenuIcon";
...
const IconsNavbar = () => {
  ...
  return (
    <>
      <div className="border-gray-500 mr-4 flex gap-5 border-r-2 py-2 pr-10 max-sm:hidden">
        {/*HiShoppingCart*/}
